...
public class Team31 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Uruguay Squad");
        ...
        FirebaseRecyclerOptions<team1model> options =
                new FirebaseRecyclerOptions.Builder<team1model>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("footballlive/team31"), team1model.class)
                        .build();
