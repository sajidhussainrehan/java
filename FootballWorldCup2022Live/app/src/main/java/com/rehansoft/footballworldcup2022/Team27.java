...
public class Team27 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Switzerland Squad");
        ...
        FirebaseRecyclerOptions<team1model> options =
                new FirebaseRecyclerOptions.Builder<team1model>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("footballlive/team27"), team1model.class)
                        .build();
